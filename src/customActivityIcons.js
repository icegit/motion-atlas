...
export const IconCamel = forwardRef(function IconCamel(
  { size = 24, color = "currentColor", stroke = 1.5, title, ...props },
  ref,
) {
  return createElement(
    ...
    createElement("path", camelNode[0][1]),
  );
});

IconCamel.displayName = "IconCamel";
